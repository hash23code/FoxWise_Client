...
import { MapPin, Navigation as NavigationIcon, List, AlertCircle, CheckCircle, Clock } from 'lucide-react'
    ...
    <div className="h-full flex">
      ...
      {showJobList && (
        <div className="w-80 bg-gray-900 border-r border-gray-800 flex flex-col">
          <div className="p-4 border-b border-gray-800">
            <h2 className="text-xl font-bold text-white mb-1">Mes Jobs</h2>
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <span className="bg-gray-700 text-white font-bold rounded-full w-6 h-6 flex items-center justify-center text-xs">
                      {index + 1}
                    </span>
      ...
      <div className="flex-1 relative">
        ...
        <button
          ...
          className="absolute top-4 left-4 bg-black/80 backdrop-blur-md text-white p-3 rounded-lg border border-white/20 hover:bg-black/90 transition-all z-10"
        >
